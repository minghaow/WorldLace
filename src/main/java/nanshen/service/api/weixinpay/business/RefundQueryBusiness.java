...
import nanshen.service.api.weixinpay.common.XMLParser;
...
import nanshen.service.api.weixinpay.protocol.refund_query_protocol.RefundOrderData;
import nanshen.service.api.weixinpay.protocol.refund_query_protocol.RefundQueryReqData;
import nanshen.service.api.weixinpay.protocol.refund_query_protocol.RefundQueryResData;
import nanshen.service.api.weixinpay.service.RefundQueryService;
...
public class RefundQueryBusiness {
    ...
    public void run(RefundQueryReqData refundQueryReqData,ResultListener resultListener) throws Exception {
        ...
        LogUtils.info(refundQueryServiceResponseString);
    ...
    private void getRefundOrderListResult(String refundQueryResponseString) throws ParserConfigurationException, SAXException, IOException {
        ...
        LogUtils.info("查询到的结果如下：");
        LogUtils.info(orderListResult);
    }
