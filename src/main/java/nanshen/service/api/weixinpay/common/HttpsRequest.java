...
import nanshen.service.api.weixinpay.service.IServiceRequest;
...
public class HttpsRequest implements IServiceRequest{
    ...
    public String sendPost(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        try {
            ...
            LogUtils.info("http get throw ConnectionPoolTimeoutException(wait time out)");

        } catch (ConnectTimeoutException e) {
            LogUtils.info("http get throw ConnectTimeoutException");

        } catch (SocketTimeoutException e) {
            LogUtils.info("http get throw SocketTimeoutException");

        } catch (Exception e) {
            LogUtils.info("http get throw Exception");
